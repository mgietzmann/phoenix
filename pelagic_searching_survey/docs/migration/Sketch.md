...
**Lead:** A second mechanism relies on smell: animals imprint on the chemical signatures of key locations during early life, encoding a series of waypoints they can follow back to specific places years later.
**Development:**
...
**Lead:** Successful migration delivers a predator to the right part of the ocean; what happens next — locating prey within that region — is a different problem entirely.
**Development:**
