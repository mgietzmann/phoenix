...
- For large pelagic fish, which species have the clearest literature connecting lateral line morphology or sensitivity to the hydrodynamic hunting context (wake tracking, flow detection in turbid/dark conditions) that selected for it?
- For large pelagic elasmobranchs, which species have the clearest literature connecting ampullary pore density or electroreceptive sensitivity to the ecological conditions — habitat type, foraging context, coastal vs. oceanic — that shaped it?
